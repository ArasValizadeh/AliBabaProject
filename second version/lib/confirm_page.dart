...
// ignore_for_file: non_constant_identifier_names, camel_case_types, prefer_const_literals_to_create_immutables, prefer_const_constructors, unused_local_variable, avoid_unnecessary_containers, unused_element
        ...
        title: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
              Icon(Icons.flight,color: Colors.green[800],),
              Icon(Icons.navigate_next,color:Color.fromARGB(255, 89, 98, 89),),
              Icon(Icons.people_alt,color: Colors.green[800],),
              Icon(Icons.navigate_next,color:Color.fromARGB(255, 89, 98, 89),),
              Icon(Icons.list_outlined,color:Colors.green[800],),
              Text("تایید اطلاعات",style: TextStyle(fontFamily: "Brb",fontSize: 15,color: Colors.green[700],fontWeight: FontWeight.bold),),
              Icon(Icons.navigate_next,color:Color.fromARGB(255, 89, 98, 89),),
...
Widget whole_page(BuildContext context){
  ...
  List<String> passenger_email = ["amirsamanrbuni@gmail.com","aras8732@gmial.com"];
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                                child: Text(passenger_nationalID[i],
                                  style: TextStyle(
                                    fontFamily: "Brb",
                                    fontSize: 18,
                                  ),
                          ...
                          Row(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                                child: Text(passenger_birthday[i],
                                  style: TextStyle(
                                    fontFamily: "Brb",
                                    fontSize: 18,
                                  ),
                          ...
                          Row(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                                child: Text(passenger_nationality[i],
                                  style: TextStyle(
                                    fontFamily: "Brb",
                                    fontSize: 18,
                                  ),
