                  ...
                  if(_controller_name_set.text != ""){
                    if(_controller__afzayesh_mojoodi_set.text != ""){
                      ...
                      future_user_info.then((value) {
                        setState(() {
                          _log = value;
                          _controller__afzayesh_mojoodi_set.text = "";
                        });
                      });
                    }
