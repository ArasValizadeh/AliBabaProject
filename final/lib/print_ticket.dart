              ...
              IconButton(
                onPressed: () {
                  setState(() {
                    ...
                    first_flight.clear_all();
                    return_flight.clear_all();
                  });
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text("شماره پیگیری : " + main_stuff.generateRandomNumber(1000, 1000),
                              style: TextStyle(
                                fontFamily: "Brb",
                                fontSize: 25,
                                color: Colors.green[700],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: Alignment.center,
                                child: Text(
                                  main_stuff.convert_city_to_persion(first_flight.arrival_city),
                                  style: TextStyle(
                                      fontFamily: "Brb",
                                      color: Colors.black,
                                      fontSize: 20,
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      width: 50,
                                      height: 50,
                                      child: Image.asset(main_stuff.convert_airline_to_icon(first_flight.airline)),
                                    ),
                                    Text(
                                      main_stuff.convert_airline_to_persian(first_flight.airline),
                                      style: TextStyle(
                                          fontFamily: "Brb",
                                          fontSize: 15,
                                          fontWeight: FontWeight.bold,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text(
                                            main_stuff.convert_city_to_persion(first_flight.departure_city),
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 15,
                                            ),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        width: 50,
                                        height: 50,
                                        child: Image.asset(main_stuff.convert_airline_to_icon(return_flight.return_airline)),
                                      ),
                                      Text(
                                        main_stuff.convert_airline_to_persian(return_flight.return_airline),
                                        style: TextStyle(
                                            fontFamily: "Brb",
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(
                                              main_stuff.convert_city_to_persion(return_flight.return_departure_city),
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                              ),
                                            ...
                                            Text(
                                              main_stuff.convert_city_to_persion(return_flight.return_arrival_city),
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                              ),
