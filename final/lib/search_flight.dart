...
Widget search_page(BuildContext context) {
  return Directionality(textDirection: TextDirection.rtl, child: status_icon());
}
...
class whole_search extends StatefulWidget {
  const whole_search({super.key});

  @override
  State<whole_search> createState() => _whole_searchState();
}

class _whole_searchState extends State<whole_search> {
  ...
  void initState() {
    super.initState();
    flight_info = _flight_info_build();
  }

  List<Widget> _flight_info_build() {
    for (int i = 0; i < first_flight.flight_raft_list.length; i++) {
      flight_info.add(Padding(
        ...
        child: GestureDetector(
          onTap: () {
            ...
            setState(() {
              first_flight.departure_city = first_flight.flight_raft_list[i][1];
              first_flight.arrival_city = first_flight.flight_raft_list[i][2];
              first_flight.departure_date = first_flight.flight_raft_list[i][4];
              first_flight.departure_time = first_flight.flight_raft_list[i][3];
              first_flight.price = first_flight.flight_raft_list[i][5];
              first_flight.airline = first_flight.flight_raft_list[i][0];
            ...
            child: Padding(
              ...
              child: SizedBox(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          main_stuff.convert_city_to_persion(
                                              first_flight.flight_raft_list[i]
                                                  [2]),
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 20,
                ...
                Row(
                  children: [
                    Text(
                      first_flight.flight_raft_list[i][6] + " صندلی باقی مانده",
                      style: TextStyle(
                          fontFamily: "Brb",
                          fontSize: 20,
                    ...
                    Expanded(child: Container()),
                    Text(
                      first_flight.flight_raft_list[i][5],
                      style: TextStyle(
                          fontFamily: "Brb",
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
