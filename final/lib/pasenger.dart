                                    ...
                                    Column(
                                      children: [
                                        SizedBox(
                                          ...
                                          height: 50,
                                          child:
                                              Image.asset(main_stuff.convert_airline_to_icon(return_flight.return_airline)),
                                        ),
                                        Text(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsets.only(top: 15),
                                            child: Text(
                                              main_stuff.convert_city_to_persion(return_flight.return_departure_time) ,
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                              ),
