          ...
          child: Center(
            child: Scaffold(
              body: FractionallySizedBox(
                heightFactor:
                    1, // Set the height factor to 1/3 of the available height
                child: Align(
                  ...
                  child: SingleChildScrollView(
                    child: GridView.count(
                      ...
                      shrinkWrap:
                          true, // Allow the GridView to wrap its content
                      crossAxisCount: 2,
                      children: [
                        buildItem(context, "هتل", widthbox: 50, heightbox: 20),
                        buildItem(context, "پرواز",
                            widthbox: 50, heightbox: 20),
                        buildItem(context, "قطار", widthbox: 50, heightbox: 20),
                        buildItem(context, "اتوبوس",
                            widthbox: 50, heightbox: 20),
              ...
              // body: FractionallySizedBox(
              //   heightFactor: 1, // Set the height factor to 1/3 of the available height
              //   child: Align(
              //     alignment: Alignment.topCenter,
              //     child: GridView.count(
              //       crossAxisCount: 2,
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (main_stuff.isLogin) {
                            //todo
                            setState(() {
                              Future<String> future_mytrip = get_tarakonesh(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (main_stuff.isLogin) {
                            setState(() {
                              Future<String> future_tarakonesh = get_tarakonesh(
                                  "MyTransactions\n" +
                                      main_stuff.login_username);
              ...
              ? () {
                  Navigator.of(context).push(PageRouteBuilder(
                      pageBuilder: (context, animation, secondaryAnimation) =>
                          main_stuff.isLogin ? safebilit() : login(),
                      transitionsBuilder:
