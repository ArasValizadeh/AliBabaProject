...
final TextEditingController _controller_departure_city =
    TextEditingController(text: "");
final TextEditingController _controller_arrivals_city =
    TextEditingController(text: "");
final TextEditingController _controller_departure_date =
    TextEditingController(text: "");
final TextEditingController _controller_passenger_count =
    TextEditingController(text: "");
final TextEditingController _controller_return_departure_city =
    TextEditingController(text: "");
final TextEditingController _controller_return_arrivals_city =
    TextEditingController(text: "");
final TextEditingController _controller_return_departure_date =
    TextEditingController(text: "");
...
class _safebilitState extends State<safebilit> {
                ...
                Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child:
                            typeCondition ? Khareji_mabdaa() : Dakheli_mabdaa(),
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      ...
                      Padding(
                        ...
                        child: TextButton(
                          onPressed: () {
                            send_user_ticket_getter_info(
                                _controller_departure_city.text +
                                    "-" +
                                    _controller_arrivals_city.text +
                                    "-" +
                                    _controller_departure_date.text +
                                    "-" +
                                    _controller_passenger_count.text);
                            print("info ticket ersaal shod");
                            print(_controller_departure_city.text +
                                "-" +
                                _controller_arrivals_city.text +
                                "-" +
                                _controller_departure_date.text +
                            ...
                            if (main_stuff.has_return_flight) {
                              send_user_ticket_getter_info(
                                  _controller_return_departure_city.text +
                                      "-" +
                                      _controller_return_arrivals_city.text +
                                      "-" +
                                      _controller_return_departure_date.text +
                                      "-" +
                                      _controller_passenger_count.text);
                              print("info ticket bargasht ham ersaal shod");
                              print(_controller_return_departure_city.text +
                                  "-" +
                                  _controller_return_arrivals_city.text +
                                  "-" +
                                  _controller_return_departure_date.text +
                          ...
                          child: SizedBox(
                            ...
                            child: FloatingActionButton.extended(
                              ...
                              onPressed: () {
                                String raft = main_stuff
                                        .convert_city_to_english(
                                            first_flight.departure_city) +
                                    "-" +
                                    main_stuff.convert_city_to_english(
                                ...
                                if (main_stuff.has_return_flight) {
                                  setState(() {
                                    bargasht = main_stuff
                                        ...
                                        (BuyTicket.number_of_passenger_adult +
                                                BuyTicket
                                                    .number_of_passenger_child)
                                            .toString();
                                  });
                                  print(bargasht);
                                }
                                setState(() {
                                  Future<String> get_ticket_raft =
                                      get_ticket_detail(
                                          "ParvazInformation\n" + raft);
                                  get_ticket_raft.then((value) {
                                    setState(() {
                                      _log = value;
                                      //print(value);
                                      List<String> tempList = value.split(',');
                                      first_flight.flight_raft_list.clear();
                                      for (String item in tempList) {
                                        List<String> splitItems =
                                            item.split('-');
                                        first_flight.flight_raft_list.add(splitItems);
                                      }
                                      print(first_flight.flight_raft_list);
                                    });
                                  });
                                  sleep(const Duration(milliseconds: 100));
                                  if (main_stuff.has_return_flight) {
                                    Future<String> get_ticket_bargasht =
                                        get_ticket_detail(
                                            "ParvazInformation\n" + bargasht);
                                    get_ticket_bargasht.then((value) {
                                      setState(() {
                                        _log = value;
                                        print(value);
                                        List<String> tempList = value.split(',');
                                      return_flight.flight_bargasht_list.clear();
                                      for (String item in tempList) {
                                        List<String> splitItems =
                                            item.split('-');
                                        return_flight.flight_bargasht_list.add(splitItems);
                                      }
                                      print(return_flight.flight_bargasht_list);
                                      });
                                    });
                                  }
                                });
  ...
  Future<String> get_ticket_detail(String message) async {
    String res = "";
    String request = message + "\u0000";
...
class Khareji_mabdaa extends StatefulWidget {
  const Khareji_mabdaa({
    Key? key,
  }) : super(key: key);

  @override
  State<Khareji_mabdaa> createState() => _khareji_mabdaaState();
}

class _khareji_mabdaaState extends State<Khareji_mabdaa> {
                ...
                child: DropdownButton<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      print("khareji mabdaa : " + value!);
                      first_flight.departure_city = value;
                      if (main_stuff.has_return_flight) {
                        return_flight.return_arrival_city = value;
                      }
                    });
                  },
...
class Khareji_maghsad extends StatefulWidget {
  const Khareji_maghsad({
    Key? key,
  }) : super(key: key);

  @override
  State<Khareji_maghsad> createState() => _Khareji_maghsadState();
}

class _Khareji_maghsadState extends State<Khareji_maghsad> {
  String? _selectedLocation;
                ...
                child: DropdownButton<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      //khareji maghsad
                      _selectedLocation = value;
                      print("dakheli maghsad: " + value!);
                      first_flight.arrival_city = value;
                      if (main_stuff.has_return_flight) {
                        return_flight.return_departure_city = value;
                        //print("return_flight.return_arrival_city =" + value);
                      }
                    });
                  },
                  icon: const SizedBox.shrink(),
...
class Dakheli_mabdaa extends StatefulWidget {
  const Dakheli_mabdaa({
    Key? key,
  }) : super(key: key);

  @override
  State<Dakheli_mabdaa> createState() => _Dakheli_mabdaaState();
}

class _Dakheli_mabdaaState extends State<Dakheli_mabdaa> {
  String? _selectedLocation;
...
class Dakheli_maghsad extends StatefulWidget {
  const Dakheli_maghsad({
    Key? key,
  }) : super(key: key);

  @override
  State<Dakheli_maghsad> createState() => _Dakheli_maghsadState();
}

class _Dakheli_maghsadState extends State<Dakheli_maghsad> {
  String? _selectedLocation;
        ...
        onTap: () async {
          ...
          if (picked != null && picked != selectedDate) {
            setState(() {
              ...
              setState(() {
                BuyTicket.return_departure_date =
                    year + "/" + month + "/" + day;
                return_flight.return_departure_date =
                    year + "/" + month + "/" + day;
                print("tarikh bargasht:  " + year + "/" + month + "/" + day);
              });
          ...
          if (picked != null && picked != selectedDate) {
            setState(() {
              ...
              setState(() {
                ...
                first_flight.departure_date = year + "/" + month + "/" + day;
                print("tarikh raft :  " + year + "/" + month + "/" + day);
              });
              if (month == "1") {
                month = "فروردین";
              } else if (month == "2") {
